...
// https://leetcode.com/problems/path-with-maximum-probability/description/comments/2594055
describe("LeetCode 1514 more tests", () => {
  it("should pass test case #3", () => {
    const res = maxProbability(
      5,
      [
    ...
    expect(res).toBeCloseTo(0.2139, 5);
  });
  it("should pass test case #4", () => {
    ...
    expect(res).toBeCloseTo(0.1, 5);
  });
  it("should pass test case #5", () => {
    const res = maxProbability(2, [], [], 0, 1);
    expect(res).toBeCloseTo(0, 5);
  });
  ...
  it("should pass test case #7", () => {
    const res = maxProbability(
      ...
      [0.1, 0.2, 0.5, 0.6, 0.3, 0.7, 0.8, 0.9, 0.4, 0.5],
      0,
      9
    );
    expect(res).toBeCloseTo(0.0378, 5);
  });
  it("should pass test case #8", () => {
    const res = maxProbability(
      ...
      [
        0.4, 0.5, 0.6, 0.7, 0.3, 0.9, 0.2, 0.1, 0.8, 0.9, 0.7, 0.6, 0.5, 0.4,
        0.3,
      ],
      0,
      14
    );
    expect(res).toBeCloseTo(0.00011, 5);
  });
});
